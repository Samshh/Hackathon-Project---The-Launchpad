...
export default function PrescriptionsSection() {
  return (
    <section className="flex flex-col col-span-3 gap-4 p-5 overflow-y-hidden bg-white rounded-xl">
      ...
      <div className="flex-grow h-1 overflow-y-auto">
        <div className="grid grid-cols-2 gap-x-4 gap-y-4">
          {Array.from({ length: 20 }).map((_, i) => {
            return (
              <button>
                <div key={i} className="rounded-lg text-start bg-[#E5E7EB] flex p-3 items-start gap-3 group hover:bg-accent">
